...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname countdown-to-display--readable) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; Countdown -> Image
;; produces an image showing the status of the countdown
