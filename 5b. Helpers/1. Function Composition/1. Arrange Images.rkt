...
;;  */y
(check-expect (loi->image (cons (square 100 "solid" "black") (cons (square 25 "solid" "red") empty)))
...
(check-expect (sort-images (cons (square 50 "solid" "black") (cons (square 10 "solid" "red") empty)))
              (cons (square 10 "solid" "red") (cons (square 50 "solid" "black") empty)))
...
(check-expect (layout-images (cons (square 50 "solid" "black") (cons (square 10 "solid" "red") empty)))
              (beside (square 10 "solid" "red")
                      (square 50 "solid" "black")))

(define (layout-images loi) (square 0 "solid" "white"))