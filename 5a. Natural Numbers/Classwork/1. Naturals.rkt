...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname naturals--readable) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; produce a list of natural numbers of the given number in a form of (cons n (cons n - 1 ... empty)) not including 0
(check-expect (to-list 0) empty)
(check-expect (to-list 3) (cons 3 (cons (- 3 1) (cons (- 3 1 1) empty))))
